package com.backendcodingtest.codingtest.common.validatemessages;

public class ItemRequestMessages {
    public static final String ITEM_NAME_BLANK_MESSAGES = "상품명은 필수 입니다. 상품명을 입력해주세요.";
    public static final String ITEM_IMAGE_URL_BLANK_MESSAGES = "상품 이미지 URL은 필수 입니다. 상품 이미지 URL을 입력해주세요.";
